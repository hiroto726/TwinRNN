...
import sys
sys.path.append(r'C:\Users\RHIRAsimulation\AppData\Local\anaconda3\envs\HirotoRNN2\RNN_scripts\my2RNN_fix2')
...
if save:
    ...
    directory = r"2sameInputs_prob005_512units_absrel_fix_weightmax_fix2"      
...
def build_model():
    ...
    hidden1=RNN(RNNCustom2Fix2(nUnit, 
                          ...
                          input_activation=tf.keras.layers.LeakyReLU(alpha=0.2),
                          use_bias=False,
