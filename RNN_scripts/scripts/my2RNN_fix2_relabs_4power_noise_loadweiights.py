...
for weight_ind in tind:
    ...
    if save:
        ...
        parent_dir = r"C:\Users\RHIRAsimulation\AppData\Local\anaconda3\envs\HirotoRNN3\RNN_models\t4rampprobvarfix"   
        # Path 
    ...
    # filter cells    
    def filtercells(act_avg_Ab2,act_avg_Bb2,act_avg_A2,act_avg_B2,
    ...
    bound=0.5
    act_avg_Ab2_sort12, act_avg_Bb2_sort12, act_avg_A2_sort12, act_avg_B2_sort12=filtercells(act_avg_Ab2,act_avg_Bb2,act_avg_A2,act_avg_B2,
                                                                                    A_bselec12,B_bselec12,A_selec12,B_selec12,
                                                                                    A_bselec6,B_bselec6,A_selec6,B_selec6,
                                                                                    start,stop,bound)
    ...
    start=0
    stop=min_dur
    act_avg_Ab2_sort6, act_avg_Bb2_sort6, act_avg_A2_sort6, act_avg_B2_sort6=filtercells(act_avg_Ab2,act_avg_Bb2,act_avg_A2,act_avg_B2,
                                                                                    A_bselec12,B_bselec12,A_selec12,B_selec12,
                                                                                    A_bselec6,B_bselec6,A_selec6,B_selec6,
                                                                                    start,stop,bound)
