...
savedirectory=r'C:\Users\RHIRAsimulation\AppData\Local\anaconda3\envs\HirotoRNN3\RNN_models\t4ramp_probvar'
...
for i in range(len(weight_max)):
    ...
    foldername.append(fr"C:\Users\RHIRAsimulation\AppData\Local\anaconda3\envs\HirotoRNN3\RNN_models\t4ramp_probvar\prob{conpro_name}_weightmax{weight_name}_fix3")
seed=11
seed1=int(seed)
...
for t in tind:
    ...
    S_A_sorted=plot_sorted_connection_matrix(
        S_matrix=S_A,
    ...
    S_B_sorted=plot_sorted_connection_matrix(
        S_matrix=S_B,
    ...
    binw=200
    dist_A=extract_average_weights_no_bins(S_A_sorted, peak_times_A[:nExc],peak_times_B, binw)
    dist_B=extract_average_weights_no_bins(S_B_sorted, peak_times_B[:nExc],peak_times_A,binw)
    dist_A=extract_average_weights_no_bins(z_score_with_zero_handling(S_A_sorted,dim=0), peak_times_A[:nExc],peak_times_B, binw)
    dist_B=extract_average_weights_no_bins(z_score_with_zero_handling(S_B_sorted,dim=0), peak_times_B[:nExc],peak_times_A,binw)
...
import scipy.io
# Load the .mat file
data = scipy.io.loadmat(r"C:\Users\RHIRAsimulation\AppData\Local\anaconda3\envs\HirotoRNN3\RNN_models\t4ramp_probvar\alldata2.mat")
