...
for weight_ind in tind:
    ...
    if save:
        ...
        directory = f"2RNNs_prob{conprobability}_weightmax{weight_name}_noise2"      
    ...
    if save:
        plt.savefig(os.path.join(savepath,f"weight_distribution_boxplot {minInd} prob{con_prob}"),transparent=True,dpi=600)
    plt.show()
