...
conProbability=[0.0001,0.0005,0.001,0.005,0.01,0.05,0.5]
model_index=[19597,19824,18802,18187,19865,19848,19861]
max_iteration=20000
...
for i in range(len(weight_max)):
    ...
    weight_name=weight_max[i]
    conpro_name=conProbability[i]
    foldername.append(fr'C:\Users\RHIRAsimulation\AppData\Local\anaconda3\envs\HirotoRNN3\RNN_models\2sameInputs_probvar{conpro_name}_weightmax{weight_name}')
