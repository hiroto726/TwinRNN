...
tind=np.arange(5,len(weight_max))
...
for weight_ind in tind:
    ...
    if save:
        ...
        directory = f"2RNNs_prob{conprobability}_weightmax{weight_name}_fix3"      
        # Parent Directory path 
        parent_dir = r"C:\Users\RHIRAsimulation\AppData\Local\anaconda3\envs\HirotoRNN3\RNN_models\t4stateful6"   
        # Path 
    ...
    while (minLoss>Loss_threashold or i % 100!=1) and i<max_iteration+1 and indic==0 :
        x, y, In_ons, Wbin=makeInOutstateful(batch_size,12,inputdur,nInput,min_dur,max_dur,dt,batch_num)
        ...
        if i % evalloop==0:
            ...
            x, y, In_ons=makeInOut(batch_size,trial_num,inputdur,nInput,min_dur,max_dur,dt)
    ...
    x, y, In_ons=makeInOut(batch_size,trial_num+4,inputdur,nInput,min_dur,max_dur,dt)
