...
def build_model():
    ...
    hidden1=RNN(RNNCustom2Fix2(nUnit, 
                          ...
                          seed=seed1,
                          tau=tau, 
                          noisesd=np.sqrt(2*tau)*0.1), #used to be 0.08 # used to be 0.05*np.sqrt(tau*2)
                stateful=False, 
...
for weight_ind in tind:
    ...
    if save:
        ...
        directory = f"2RNNs_prob{conprobability}_weightmax{weight_name}_highernoise"      
        # Parent Directory path 
        parent_dir = r"C:\Users\RHIRAsimulation\AppData\Local\anaconda3\envs\HirotoRNN3\RNN_models\t4rampprobvar_mosenoise"   
        # Path 
