...
for i in range(len(weight_max)):
    ...
    foldername.append(fr"C:\Users\RHIRAsimulation\AppData\Local\anaconda3\envs\HirotoRNN3\RNN_models\2RNNs_alpha1_prob{conpro_name}_weightmax{weight_name}_fix3")
...
for weight_ind in tind:
    ...
    if save:
        ...
        directory = f"2RNNs_alpha1_prob{conprobability}_weightmax{weight_name}_fix3__noise2"      
    ...
    axs[1,1].set_title('B after training')    
    if save:
        plt.savefig(os.path.join(savepath,f"sequentiality_comparison_imshow_{minInd}"),transparent=True,dpi=600)
