# -*- coding: utf-8 -*-
"""
Created on Sun Dec 29 21:52:37 2024
...
tind=np.arange(0,len(weight_max))
...
for weight_ind in tind:
    ...
    if save:
        ...
        parent_dir = fr"C:\Users\RHIRAsimulation\AppData\Local\anaconda3\envs\HirotoRNN3\RNN_models\t4stateful_0prob"   
        # Path 
