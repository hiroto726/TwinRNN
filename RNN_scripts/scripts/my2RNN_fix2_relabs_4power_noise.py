...
def build_model():
    ...
    hidden1=RNN(RNNCustom2FixPerturb_noise_prob_train(nUnit, 
                          ...
                          tau=tau, 
                          noisesd=0.08,
                          pert_noisesd=0), # used to be 0.05*np.sqrt(tau*2)
                stateful=False, 
...
for weight_ind in range(len(weight_max)):
    ...
    if save:
        ...
        directory = f"2RNNs_prob{conprobability}_weightmax{weight_name}_noise"      
        # Parent Directory path 
        parent_dir = r"C:\Users\ifumi\anaconda3\envs\myRNN1\RNNModels"   
        # Path 
