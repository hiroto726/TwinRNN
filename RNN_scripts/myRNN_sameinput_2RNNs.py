...
if save:
    ...
    directory = r"2sameInputs_reluMax_3s6s_fewTrials_RNN2_ver5"      
...
trial_num=2
con_prob=1.0 # probability of connection between neurons
...
def build_model():
    ...
    hidden1=RNN(RNNCustom2(nUnit, 
                          ...
                          recurrent_initializer=OrthoCustom2(gain=0.01, seed=seed1 , nUnit=nUnit, nInh=nInh),
...
optimizer_smallstep=tf.keras.optimizers.Adam(learning_rate=0.00002,clipvalue=0.00001) # added 5/6/2024
...
# Path 
savepath = r"C:\Users\Fumiya\anaconda3\envs\myRNN3\RNN_Models\myRNN_fewtrials_1024units"  
k=9293
...
plt.tight_layout()
if save:
    plt.savefig(os.path.join(savepath,f"Output_{int_list}"),transparent=True,dpi=200)
plt.show()
